//this is old js that may or may not be used in the future, but for now it's dated
...
function createMiniCalendar(container) {
    ...
    //content = jQuery('<div class = "calendar-popover-content"></div>');
    //jQuery($(content).append(minicalendar));
